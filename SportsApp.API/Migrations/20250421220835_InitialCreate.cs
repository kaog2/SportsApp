        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTags_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatchesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    PlayersId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMatch", x => new { x.MatchesId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserMatch_AspNetUsers_PlayersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMatch_PlayersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTags_ApplicationUserId",
                table: "UserTags",
